...
| 3 | `run_parameter_estimation_fast.py` | trained networks (`models/sfi_fast_{ddm,oum}.keras`), posterior `.npy` files, recovery figures (Appendix A3) |
| 4 | `run_parameter_estimation_slow.py` | trained networks (`models/sfi_slow_{ddm,oum}.keras`), posterior `.npy` files, recovery figures (Appendix A4) |
...
- Summary network: SetTransformer (12 dimensions)
...
| *a* | 8·σ(𝒩(−1.6, 1.0)) | 8·σ(𝒩(−0.25, 1.0)) | 10·σ(𝒩(−0.7, 1.0)) | 10·σ(𝒩(0.5, 1.2)) |
| *τ* | U(0.1, 1.0) | U(0.1, 1.0) | U(0.1, 3.0) | U(0.1, 3.0) |
| *k* | — | Γ(8.0, 0.5) | — | Γ(3.0, 0.3) |
